...
@section('content')
  ...
  <div class="page-content row">
	...
	@include('admin.sximo.module.tab',array('active'=>'sub'))
...
<div class="sbox">
  ...
  @if(count($subs) < 1)
    {!! Form::open(array('url'=>'admin/sximo/module/savesub/'.$module_name, 'class'=>'form-horizontal  ')) !!}
 ...
 @endif
    ...
    <tbody class="no-border-x no-border-y"> 
      ...
      <tr>
        ...
        onclick="SximoConfirmDelete('{{ URL::to('admin/sximo/module/removesub?id='.$row->module_id.'&mod='.$rows['module']) }}');" 
