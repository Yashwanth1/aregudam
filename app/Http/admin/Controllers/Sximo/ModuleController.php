...
class ModuleController extends Controller {
	...
	public function getIndex( Request $request)
	{
		...
		return view('admin.sximo.module.index',$this->data);
	}
    ...
    function getCreate()
    {
        ...
        return view('admin.sximo.module.create',$this->data);       
    ...
    function postCreate( Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if($request->input('creation') == 'manual')
            {
                if($where =="")                
                {
                    return Redirect::to('admin/sximo/module/create')                    
        ...
        //    echo '<pre>'; print_r($columns); echo '</pre>';    exit;
            ...
            if(count($row) >= 1)
            {
                ...
                return Redirect::to('admin/sximo/module/rebuild/'.$id->module_id);        
            } else {
                return Redirect::to('admin/sximo/module');
            }
    ...
    function getDestroy( $id = null )
    {
        $row = \DB::table('tb_module')->where('module_id', $id)
                                ->get();        
        if(count($row) <= 0){
            return Redirect::to('admin/sximo/module')->with('messagetext','Can not find module')->with('msgstatus','error');   
    ...
    function getConfig( $id )
    {
		...
		return view('admin.sximo.module.config',$this->data);        
    ...
    function postSaveconfig( Request $request) 
    {
        ...
        if ($validator->passes()) {
            ...
            return Redirect::to('admin/sximo/module/config/'.$request->input('module_name'))
    ...
    function getSql(Request $request , $id )
    {
		...
		$this->data['module_name'] 		= $row->module_name;    
		$this->data['module'] 			= 'module';
		return view('admin.sximo.module.sql',$this->data);
    ...
    function postSavesql( Request $request ,$id )
    {
        ...
        try {   
            ...
            // Do something when query fails. 
            $error ='Error : '.$select .' '.$where.' '.$group ;
            return Redirect::to('admin/sximo/module/sql/'.$request->input('module_name'))
       ...
       \DB::table('tb_module')
        ...
        return Redirect::to('admin/sximo/module/sql/'.$row->module_name)
    ...
    function getTable( $id )
    {
		...
		$this->data['module'] = 'module';
		$this->data['module_name'] = $row->module_name;
		return view('admin.sximo.module.table',$this->data);
    ...
    function getForm( $id )
    {
		...
		$this->data['module'] = 'module';
		$this->data['module_name'] = $row->module_name;
		return view('admin.sximo.module.form',$this->data);
    ...
    public function postSaveform( Request $request)
    {
       ...
       // echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
        ...
        return Redirect::to('admin/sximo/module/form/'.$row->module_name)
    ...
    public function getEditform(Request $request, $id )
    {
        ...
        $this->data['module'] = 'module';
        $this->data['module_name'] = $row->module_name;
        return view('admin.sximo.module.field',$this->data);
    } 
   ...
   function postSaveformfield( Request $request)
    ...
    public function postSavetable( Request $request)
    {
       ...
       // echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
        ...
        return Redirect::to('admin/sximo/module/table/'.$row->module_name)
   ...
   function getPermission( $id )
    {
            ...
            */   
            ...
            return view('admin.sximo.module.permission',$this->data);
    ...
    public function postSavepermission( Request $request)
    {
        ...
        */         
        ...
        return Redirect::to('admin/sximo/module/permission/'.$row->module_name)
    ...
    function getBuild( $id )
    {
        ...
        return view('admin.sximo.module.build',$this->data);
    ...
    function getFormdesign( Request $request , $id)
    {
        ...
        $this->data['module_name'] = $row->module_name;
        return view('admin.sximo.module.formdesign',$this->data);    
    }   
    ...
    //    echo '<pre>'; print_r($f); echo '</pre>';    exit;
     ...
     //  echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
      \DB::table('tb_module')
        ...
        return Redirect::to('admin/sximo/module/formdesign/'.$row->module_name)
    ...
    function getSub( Request $request, $id ='')
    {
		...
		return view('admin.sximo.module.sub',$this->data);    
    ...
    function postSavesub( Request $request)
    {
        ...
        if ($validator->passes()) {                
          ...
          //  echo '<pre>'; print_r($new_config); echo '</pre>'; exit;
            ...
            return Redirect::to('admin/sximo/module/sub/'.$row->module_name)
            ->with('messagetext','Master Has beed added Successful.')->with('msgstatus','success');  

        }    else {

            return Redirect::to('admin/sximo/module/sub/'.$request->get('module_name'))
    ...
    function getConn( Request $request , $id )
    {
        ...
        return view('admin.sximo.module.connection',$this->data);
    }   
   ...
   function configGrid ( $field , $alias , $type, $sort ) {
    ...
    public function getRebuild(Request $request, $id = 0)
    {
            ...
            /* End Master Detail */
            $dir = base_path().'/resources/admin/views/'.$class; 
           
            $dirC = app_path().'/Http/admin/Controllers/';
            $dirM = app_path().'/admin/Models/';
            ...
            if($row->module_type =='generic')
            {
                ...
                $template = base_path().'/resources/admin/views/sximo/module/template/blank/';
            ...
            {
                $template   = base_path().'/resources/admin/views/sximo/module/template/report/';
                $controller = file_get_contents( $template.'controller.tpl' );
                $grid       = file_get_contents(  $template.'grid.tpl' );
                $model       = file_get_contents(  $template.'model.tpl' );  
            ...
            if($row->module_type =='addon')
            {
                ...
                $template = base_path().'/resources/admin/views/sximo/module/template/native/';
                $controller = file_get_contents(  $template.'controller.tpl' );
                $grid = file_get_contents(  $template.'grid.tpl' );               
                $view = file_get_contents(  $template.'view.tpl' );
                $form = file_get_contents(  $template.'form.tpl' );
            ...
            return Redirect::to('admin/sximo/module')->with('messagetext','Code Script has been replaced successfull')->with('msgstatus','success');   
    ...
    function postPackage( Request $request) 
    {
        ...
        return view('admin.sximo.module.package',$this->data);  
    ...
    function postDopackage( Request $request) 
    {
        ...
        foreach ( $_modules as $n => $_module ){ 
          ...
          $cf_zip->add_data( "app/Http/admin/Controllers/". ucwords($file)."Controller.php", 
                              file_get_contents( $app_path."/Http/admin/controllers/". ucwords($file)."Controller.php")) ; 
          $cf_zip->add_data( "app/admin/Models/". ucwords($file).".php", file_get_contents($app_path."/models/". ucwords($file).".php")) ;
          $cf_zip->get_files_from_folder( "../resources/admin/views/{$file}/","../resources/admin/views/{$file}/" ); 
  ...
  function postInstall( Request $request ,$id =0)
  {
    ...
    if ($validator->passes()) {
      ...
      self::createRouters();
          ...
          return Redirect::to('admin/sximo/module')->with('messagetext','Module Installed' . $msg)->with('msgstatus','success');
    }  else  {
         return Redirect::to('admin/sximo/module')->with('messagetext','Please select file to upload !')->with('msgstatus','error');
    } 
