...
class PagesController extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		return view('admin.core.pages.index',$this->data);
	}	
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		$this->data['id'] = $id;
		return view('admin.core.pages.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		return view('admin.core.pages.view',$this->data);	
	}	
	...
	function postSave( Request $request, $id =0)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to('admin/core/pages/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('id')) >=1)
		{
			...
			self::createRouters();
			return Redirect::to('admin/core/pages')
