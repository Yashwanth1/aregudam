      ...
      <div class="page-title">
        <h3> {{ $pageTitle }} <small>{{ $pageNote }}</small></h3>
		  ...
		  <ul class="breadcrumb">
			...
			<li><a href="{{ URL::to('admin/core/pages') }}">{{ $pageTitle }}</a></li>
...
<div class="page-content-wrapper">
	...
	@endif	
		...
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'admin/core/pages/save/'.$row['pageID'], 'class'=>'form-vertical row ','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
