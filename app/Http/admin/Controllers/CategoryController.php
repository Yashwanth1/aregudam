...
class CategoryController extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		$sort = (!is_null($request->input('sort')) ? $request->input('sort') : 'pk_category_id'); 
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			$data = $this->validatePost('tb_category');
			...
			$id = $this->model->insertRow($data , $request->input('pk_category_id'));
			...
			if($request->input('pk_category_id') =='')
			{
			...
			return Redirect::to('admin/category/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
