...
@section('content')
  ...
  <div class="panel-default panel">
    ...
    <ul class="parsley-error-list">
     ...
     {!! Form::open(array('url'=>'admin/sximo/module/dopackage', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
          <div class="col-md-6">
              <div class="header" >
      ...
      <div style="clear:both"></div>  
        ...
        <button type="button" onclick="location.href='{{ URL::to('admin/module') }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
        </div>    
