...
class HomeController extends Controller {
	...
	public  function  postContact( Request $request)
	{
		...
		if ($validator->passes()) 
		{
			...
			return Redirect::to('admin/'.$request->input('redirect'))->with('message', \SiteHelpers::alert('success','Thank You , Your message has been sent !'));	
				
		} else {
			return Redirect::to('admin/'.$request->input('redirect'))->with('message', \SiteHelpers::alert('error','The following errors occurred'))
