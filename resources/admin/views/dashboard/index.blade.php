...
<section>
	<div class="row m-l-none m-r-none m-t  white-bg shortcut " >
		<div class="col-sm-6 col-md-3 b-r  p-sm ">
			...
			<a href="{{ URL::to('admin/sximo/module') }}" class="clear">
		...
		<div class="col-sm-6 col-md-3 b-r  p-sm">
			...
			<a href="{{ URL::to('admin/sximo/config') }}" class="clear">
		...
		<div class="col-sm-6 col-md-3 b-r  p-sm">
			...
			<a href="{{ URL::to('admin/sximo/menu') }}" class="clear">
		...
		<div class="col-sm-6 col-md-3 b-r  p-sm">
			...
			<a href="{{ URL::to('admin/core/users') }}" class="clear">
