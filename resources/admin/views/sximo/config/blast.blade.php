...
<div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
       <li><a href="{{ URL::to('admin/sximo/dashboard') }}">{{ Lang::get('core.home') }}</a></li>
...
{!! Form::open(array('url'=>'admin/sximo/config/doblast/', 'class'=>'form-horizontal ','parsley-validate'=>' ' ,'novalidate'=>' ')) !!}
