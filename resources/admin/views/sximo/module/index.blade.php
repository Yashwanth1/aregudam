...
<div class="page-content row">
		...
		<section >
				...
				<div class="row m-l-none m-r-none m-t  white-bg shortcut " >
					<div class="col-sm-3 b-r  p-sm ">
						...
						<a href="{{ URL::to('admin/sximo/module/create') }}" class="clear">
					...
					<div class="col-sm-3 b-r  p-sm">
						...
						<a href="{{ URL::to('admin/sximo/module/package') }}" class="clear post_url">
					...
					<div class="col-sm-6 col-md-3 b-r  p-sm">
						...
						<a href="{{ URL::to('admin/sximo/tables') }}" >
	...
	@endif	
      <div class="white-bg p-sm m-b unziped" style=" border:solid 1px #ddd; display:none;">
	   {!! Form::open(array('url'=>'admin/sximo/module/install/', 'class'=>'breadcrumb-search','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
 	...
 	<ul class="nav nav-tabs" style="margin-bottom:10px;">
	  <li @if($type =='addon') class="active" @endif><a href="{{ URL::to('admin/sximo/module')}}"> {{ Lang::get('core.tab_installed') }}  </a></li>
	  <li @if($type =='core') class="active" @endif><a href="{{ URL::to('admin/sximo/module?t=core')}}">{{ Lang::get('core.tab_core') }}</a></li>
	</ul>     

	 {!! Form::open(array('url'=>'admin/sximo/module/package#', 'class'=>'form-horizontal' ,'ID' =>'SximoTable' )) !!}
			...
			<tr>		
				...
				<I class="icon-cogs"></I> <span class="caret"></span>
					...
					<ul style="display: none;" class="dropdown-menu icons-right">
						<li><a href="{{ URL::to('admin/'.$row->module_name)}}"><i class="icon-grid"></i> {{ Lang::get('core.btn_view') }} Module </a></li>
						<li><a href="{{ URL::to('admin/sximo/module/config/'.$row->module_name)}}"><i class="icon-pencil3"></i> {{ Lang::get('core.btn_edit') }}</a></li>						
						<li><a href="javascript://ajax" onclick="SximoConfirmDelete('{{ URL::to('admin/sximo/module/destroy/'.$row->module_id)}}')"><i class="icon-bubble-trash"></i> {{ Lang::get('core.btn_remove') }}</a></li>
						<li class="divider"></li>
						<li><a href="{{ URL::to('admin/sximo/module/rebuild/'.$row->module_id)}}"><i class="icon-spinner7"></i> Rebuild All Codes</a></li>
	...
	@else
		...
		<br /><br />
		<a href="{{ URL::to('admin/sximo/module/create')}}" class="btn btn-default "><i class="icon-plus-circle2"></i> New module </a>
		 </p>	
	@endif
	</div>	
	{!! Form::close() !!}
