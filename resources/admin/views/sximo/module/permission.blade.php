...
@section('content')
  ...
  <div class="page-content row">
	...
	@include('admin.sximo.module.tab',array('active'=>'permission','type'=>$type))

@if(Session::has('message'))
       {{ Session::get('message') }}
@endif

 {!! Form::open(array('url'=>'admin/sximo/module/savepermission/'.$module_name, 'class'=>'form-horizontal')) !!}
