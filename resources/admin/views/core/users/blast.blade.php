...
<div class="page-content row">
 ...
 <div class="page-content-wrapper m-t">  
  <ul class="nav nav-tabs" style="margin-bottom:10px;">
    ...
    <li class=""><a href="{{ URL::to('admin/core/groups')}}"><i class="fa fa-users"></i> Groups</a></li>
    <li class="active"><a href="{{ URL::to('admin/core/users/blast')}}"><i class="fa fa-envelope"></i> Send Email </a></li>
  </ul> 
...
{!! Form::open(array('url'=>'admin/core/users/doblast/', 'class'=>'form-horizontal ','parsley-validate'=>' ' ,'novalidate'=>' ')) !!}
