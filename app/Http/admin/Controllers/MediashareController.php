...
class MediashareController extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		return view('admin.mediashare.index',$this->data);
	}	
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		$this->data['id'] = $id;
		return view('admin.mediashare.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		return view('admin.mediashare.view',$this->data);	
	}	
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			$data = $this->validatePost('tb_mediashare');
			
			$id = $this->model->insertRow($data , $request->input('pk_social_media_id'));
			
			if(!is_null($request->input('apply')))
			{
				$return = 'mediashare/update/'.$id.'?return='.self::returnUrl();
			} else {
				$return = 'mediashare?return='.self::returnUrl();
			}
			...
			return Redirect::to('admin/mediashare/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('id')) >=1)
		{
			...
			// redirect
			return Redirect::to('admin/mediashare')
