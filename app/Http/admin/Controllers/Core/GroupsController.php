...
class GroupsController extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		return view('admin.core.groups.index',$this->data);
	}	
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		$this->data['id'] = $id;
		return view('admin.core.groups.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		return view('admin.core.groups.view',$this->data);	
	}	
	...
	function postSave( Request $request, $id =0)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to('admin/core/groups?return='.self::returnUrl())->with('messagetext',\Lang::get('core.note_success'))->with('msgstatus','success');
			
		} else {

			return Redirect::to('admin/core/groups/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('id')) >=1)
		{
			...
			// redirect
			return Redirect::to('admin/core/groups')
