...
@section('content')
  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('admin/sximo/module') }}">{{ Lang::get('core.t_module') }}</a></li>
 ...
 {!! Form::open(array('url'=>'admin/sximo/module/create/', 'class'=>'form-horizontal', 'parsley-validate'=>'','novalidate'=>'')) !!}
