...
@section('content')
  <div class="page-content row">
	...
	@include('admin.sximo.module.tab',array('active'=>'table'))

@if(Session::has('message'))
       {{ Session::get('message') }}
@endif

 {!! Form::open(array('url'=>'admin/sximo/module/savetable/'.$module_name, 'class'=>'form-horizontal')) !!}
<div class="sbox">
			...
			<?php usort($tables, "SiteHelpers::_sort"); ?>
			  ...
			  <tr >
				...
				<span class=" xlick btn-primary btn-xs tips" title="Lookup Display" 
					onclick="SximoModal('{{ URL::to('admin/sximo/module/conn/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}' ,' Connect Field : {{ $rows['field']}} ' )"
					>
