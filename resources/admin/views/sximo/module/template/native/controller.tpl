...
class {controller}Controller extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		return view('admin.{class}.index',$this->data);
	}	
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		{masterdetailgrid}
		$this->data['id'] = $id;
		return view('admin.{class}.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		return view('admin.{class}.view',$this->data);	
	}	
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to('admin/{class}/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
