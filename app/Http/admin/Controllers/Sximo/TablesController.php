...
class TablesController extends Controller 
{
   	...
   	public function getIndex()
	{
		...
		return view('admin.sximo.tables.index',$this->data);
	}   
    ...
    public function getTableconfig( $table = null )
    {
        ...
        return view('admin.sximo.tables.config',$this->data);
    }   
    ...
    public function postTableremove(Request $request)
    {
        ...
        if(!is_null($request->input('id')) && count($request->input('id')) >=1 )
        {
            ...
            return Redirect::to('admin/sximo/tables')->with('messagetext', 'Table(s) has been deleted')->with('msgstatus','success');  
        } 
        return Redirect::to('admin/sximo/tables')->with('messagetext','error','No Table(s) deleted !')->with('msgstatus','error');  
    ...
    public function getTablefieldedit( $table )
    {
        ...
        return view('admin.sximo.tables.field',$this->data);
    }
    ...
    public function getMysqleditor()
    {
        ...
        return view('admin.sximo.tables.editor');
    }   
