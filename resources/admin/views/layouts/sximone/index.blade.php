        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 left">
                 <ul class="list-unstyled list-inline">
					...
					@foreach(SiteHelpers::langOption() as $lang)
						<li><a href="{{ URL::to('admin/home/lang/'.$lang['folder']) }}"> 
            ...
            <div class="col-md-6 col-sm-6 right">
                <ul class="list-unstyled list-inline pull-right">
                     @if(!Auth::check()) 
					 	<li><a href="{{ URL::to('admin/user/login') }}"><i class="fa fa-sign-in"></i> {{ Lang::get('core.signin') }}</a></li>
                    	<li><a href="{{ URL::to('admin/user/register') }}"><i class="fa fa-user"></i> {{ Lang::get('core.signup') }}</a></li>
					 @else
					 	<li><a href="{{ URL::to('admin/user/profile') }}"><i class="fa fa-user "></i> {{ Lang::get('core.m_myaccount') }}</a></li>
                    	<li><a href="{{ URL::to('admin/dashboard') }}"><i class="fa fa-desktop"></i> {{ Lang::get('core.m_dashboard') }}</a></li>	
	...
	<div class="container">
		<div class="navbar navbar-default ">			
				<div class="navbar-header">
					...
					<a href="{{ URL::to('admin/') }}" class="navbar-brand site-logo">
				...
				<div class="navbar-collapse collapse">
					@include('admin.layouts/sximone/topbar')
				</div><!--/nav-collapse -->
			</div><!-- /container -->
		</div>
</header>		
